"""
Calculates FPR of Premise on the Normal data. The classification is considered as positive if there are <period>
sequential (w/o interruption) positive classifications with identical localisations (identification of the
same node/recourse as a faulty one)
"""
...
file_path_classifications = "resources/data/15-premise-data/classifications-2-{classification_model_name}/{exp_code}.csv"
